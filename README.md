...
我想 from scratch 训练一个基模。虽然训练路线很清晰，但是我没有公开路线的欲望。言尽于此。

## 设计上正确

到现在我已经谈论了「设计上正确」许多次。这是一种对 The Right Way 的套用，而「事后打补丁」则是 Worse Is Better。

我想大家对于 ranking criteria 肯定有许多意见，无论是有没有建设性（而不是好不好），因为建设性的意见单纯就是对对面的 trade-off 互喷。

一个事实是，graveyard beatmaps 和 ranked 的唯一区别是标签不同。在 ranked 谱面的基础上微调 LoRA，或者说 Continued Pretraining，这两个都体现了一个人对 ranked 的态度。如果这个人觉得 ranked 是「正确」，那么他自然选择前面两个。如果一个人认为啊 ranked 区就要完蛋了，那么他自然就觉得 ranked 区有分布上的偏移。他可能还会觉得这个标签变质了，或者观察到标签和时间变化了。

标签从来和质量就没有关系，只是说我们可以有一个「高质量」的标签。有时候我感觉谱面的质量是不存在的，就像标签是不存在的一样，有的只是人类对谱面的看法。而这最终就形成了「正确」。
...
前面讲了一大段人对工具的正确性，这里讲的是工具对人的正确性。

每一年都有人问类似的问题：`Is it a bad decision to play osu?`（参看 <https://www.reddit.com/r/osugame/comments/1hd3txz/is_it_a_bad_decision_to_play_osu/>）

我一直觉得 osu! 是一个单机游戏，它的社区是附赠的，就像 Etterna 和 Etterna Online 一样。一个是取乐工具，一个是取乐方式。

现在有一堆人意识过来了，「玩游戏不混圈」才是最佳实践。问题是 osu! 不是这种游戏。osu! 一开始就是要做社区，这是 peppy 的 The Right Way，不然我们就没 beatmaps 打了。在 Danbooru 你随便注册一个账号，上传个图，打标，就会有人 approve 你。这游戏很快就 20 年了，和 Danbooru 不同，你去 Rank 图时，还是要经过社区。这不是说建立社区的方向错了，只是说「玩游戏不混圈」的人不被看见，因为「不混圈」的人的特征就是不会被看见。如果系统对于他们出错了，他们不会被看见，系统就会觉得自己没错。有错的地方改起来像 The Right Way。不会被看见的问题看起来像不存在。

我们有 Lazer，这是一件好事。开源了、误差标准化了、打击计数（如 SBrk、滑条 Tick）的 api 有了、网站-应用-多平台这一点甚至是全世界唯一解。游戏本身，或者说基础设施一直在变好，但是具体的人具体的处境没有改变。我们照样有 pedos 威胁；一些群体照样有心理问题；或者说，我们一直有社区。上面讨论了几次「设计上正确」，但是实践中，Worse is better 才能够出现项目。在 Day One，ppy 就是「我想要在 pc 玩这个游戏」中写 osu! 的，然后他再搞了别的三个模式。所以他其实自己就定义了 The Right Way，因为他是第一批用户，第一批用户决定了改进的方向，并且社区这条路走得非常好，非常正确，正确就正确在对需要社区的人正确，所以 osu! 就会一直正确下去。不需要社区的人的痛苦就是这样被排除在外的。他们没有理由抱怨被排除在外，因为这是 Worse is better 本身的 feature。

有没有可能存在一个 Day One 足够好，以至于 20 年后不会有人对自己说「我不需要社区」？现实答案是没有，因为这本身就是自相矛盾的。这不是因为 dev 蠢，而是他们确实看不见，即使看见了他们也觉得优先级比较低。Worse is better 在筛选哪一些人的痛苦能被看到，哪一些人的痛苦不能。你能做的最好事情，就是祈祷自己在 The Right Way 当中，如果你一开始就被 Worse is better 排除了，你可能最终发现，你不需要玩这个游戏，因为你意识到这个游戏系统性地排除了你，仅仅是因为你只是想为了做你想做的事。
